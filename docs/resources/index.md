...
:::{grid-item-card}
:padding: 1
:img-top: ../system-admin/images/System-Administrators-Bare-Metal-AMD-AMD-SMI.jpg
...
:::{grid-item-card}
:padding: 1
:img-top: ../system-admin/images/enterpriseAI.png
:class-img-top: small-sd-card-img-top
:class-body: small-sd-card
:class: small-sd-card
+++
...
:::{grid-item-card}
:padding: 1
:img-top: ../system-admin/images/omnistat.jpg
:class-img-top: small-sd-card-img-top
:class-body: small-sd-card
:class: small-sd-card
+++
...
:::{grid-item-card}
:padding: 1
:img-top: ../system-admin/images/System-Administrators-Bare-Metal-AMD-Tools.jpg
:class-img-top: small-sd-card-img-top
:class-body: small-sd-card
:class: small-sd-card
+++
...
:::{grid-item-card}
:padding: 1
:img-top: ../system-admin/images/gpu-operator.jpg
:class-img-top: small-sd-card-img-top
:class-body: small-sd-card
:class: small-sd-card
+++
