...
![Structure of a single GCD in the AMD Instinct MI100 accelerator](../images/gpu-arch/image004.png "Node-level system architecture with two AMD EPYC™ processors and eight AMD Instinct™ accelerators.")
...
![Structure of the AMD Instinct accelerator (MI100 generation)](../images/gpu-arch/image005.png "Structure of the AMD Instinct accelerator (MI100 generation)")
...
![Block diagram of an MI100 compute unit with detailed SIMD view of the AMD CDNA architecture](../images/gpu-arch/image006.png "An MI100 compute unit with detailed SIMD view of the AMD CDNA architecture")
